...
const Mpesapayment = () => {
    ...
    // we pass the satae of our card from the component getproducts component.
    ...
    const submit = async e => {
        ...
        data.append("amount", food.food_cost)
  ...
  return (
    <div className='row justify-content-center mt-3'>
      ...
      <h4 > Product Name: <span className='text-primary'>{food.food_name}</span> </h4>
      
      <form onSubmit={submit}>
        

        <h4>Cost of the product: <span className='text-primary'>{food.food_cost}</span></h4>
