...
const Mpesacosmetic = () => {
    ...
    const { cosmetic } = useLocation().state || {};
    ...
    const submit = async e => {
        ...
        data.append("amount", cosmetic.cosmetic_cost)
  ...
  return (
    <div className='row justify-content-center mt-3'>
      ...
      <h4 > Product Name: <span className='text-primary'>{cosmetic.cosmetic_name}</span> </h4>
      
      <form onSubmit={submit}>
        
        <h4>Cost of the product: <span className='text-primary'>{cosmetic.cosmetic_cost}</span></h4>
