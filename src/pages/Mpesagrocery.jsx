...
const Mpesagrocery = () => {
    ...
    const submit = async e => {
        ...
        data.append("amount", grocery.grocery_cost)
  ...
  return (
    <div className='row justify-content-center mt-3'>
      ...
      <h4 > Product Name: <span className='text-primary'>{grocery.grocery_name}</span> </h4>
      
      <form onSubmit={submit}>
        

        <h4>Cost of the product: <span className='text-primary'>{grocery.grocery_cost}</span></h4>
