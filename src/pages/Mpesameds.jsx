...
const Mpesameds = () => {
    ...
    const submit = async e => {
        ...
        data.append("amount", med.medicine_cost)
  ...
  return (
    <div className='row justify-content-center mt-3'>
      ...
      <h4 > Product Name: <span className='text-primary'>{med.medicine_name}</span> </h4>
      
      <form onSubmit={submit}>
        
        <h4>Cost of the product: <span className='text-primary'>{med.medicine_cost}</span></h4>
