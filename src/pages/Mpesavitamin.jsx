...
const Mpesavitamin = () => {
    ...
    const { vitamin } = useLocation().state || {};
    ...
    const submit = async e => {
        ...
        data.append("amount", vitamin.vitamin_cost)
  ...
  return (
    <div className='row justify-content-center mt-3'>
      ...
      <h4 > Product Name: <span className='text-primary'>{vitamin.vitamin_name}</span> </h4>
      
      <form onSubmit={submit}>
        
        <h4>Cost of the product: <span className='text-primary'>{vitamin.vitamin_cost}</span></h4>
